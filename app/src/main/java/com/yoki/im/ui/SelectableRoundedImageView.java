...
//        }
//        this.mLeftTopCornerRadius = (float) a.getDimensionPixelSize(4, 0);
//        this.mRightTopCornerRadius = (float) a.getDimensionPixelSize(7, 0);
//        this.mLeftBottomCornerRadius = (float) a.getDimensionPixelSize(3, 0);
//        this.mRightBottomCornerRadius = (float) a.getDimensionPixelSize(6, 0);
...
//        this.mBorderWidth = (float) a.getDimensionPixelSize(2, 0);
